                            ...
                            <Row>
                                <Column sm={4} md={8} lg={16}>
                                    <div className="faq_wrap">
                                        ...
                                        <a href="javascript:void(0)">What is Lorem ipsum dolor?</a>
                                        <a href="javascript:void(0)">How is Lorem ipsum dolor sit? </a>
                                        <a href="javascript:void(0)">Need additional support?</a>
                                    </div>
